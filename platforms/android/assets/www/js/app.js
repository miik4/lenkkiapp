...
lenkkiApp.controller("lenkkiAppCtrl", function ($scope, $ionicPlatform, $cordovaGeolocation, $ionicPopup, $http) {
    ...
    $ionicPlatform.ready(function() {
        ...
        function Start() {
            $cordovaGeolocation.getCurrentPosition({
                                            ...
                                            function (paikkatieto) {//onnistunut
                                                ...
                                                //niin ja täytyy kutsua näin...jos $cordovaGeolocation.watchCurrentPosition tyylillä yrittää, niin ei toimi kirveelläkään... vaikka koodit ottais suoraan dokumentaatiosta... gps kuvake tulee kyllä puhelimeen ja näyttäis toimivan, mutta ei ikinä suorita onnistunut tai epäonnistunut functiota vaan jauhaa vain... 
        ...
        function onnnistunut(paikkatieto) {
            ...
            ed_lon = nyk_lon;//korjataan näitten avulla ettei tallenneta turhaan gps pisteitä arrayhyn ellei jompikumpi niistä muutu, vaikkakin dokumentaatio antoi ymmärtää, että tätä kutsutaan vain kun gps pisteet muuttuu, mutta silti kutsuu tätä tietyn väliajoin niin muuttumattomia koordinaatteja menee ihan turhaan arrayhyn ja sitä myöten kantaan jne jne....
            ed_lat = nyk_lat;
            nyk_lat = paikkatieto.coords.latitude;
            nyk_lon = paikkatieto.coords.longitude;
            nyk_nopeus = (paikkatieto.coords.speed*3.6).toFixed(2);//palauttaa metrejä sekunnissa joten *3.6 on km/h
            ...
            if(LenkkiKaynnisssa) {
                ...
                for (var i = 0; i < kaikkiLenkinPisteet.length; i++) {//lenkin pituuden laskeminen...vähän ehkä kökkö tapa ja ei kovin "optimaalinen" tapa, mutta eipä muutakaan keksinyt...
...
function laskeEtaisyys(lat1, lon1, lat2, lon2) {//varastettu Jukan windowsohjelmointi kurssin demosta...tietysti muokattu jscriptiksi...
